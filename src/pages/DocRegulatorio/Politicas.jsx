...
const Politicas = () => {
  ...
  const fetchPoliticas = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/getPoliticas`);
      if (!response.ok) {
  ...
  const createPolitica = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/add_politica`, {
        method: 'POST',
        headers: {
  ...
  const updatePolitica = async (id) => {
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/edit_politica/${id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const deletePolitica = async (id) => {
    ...
    if (confirm.isConfirmed) {
      try {
        const response = await fetch(`${import.meta.env.VITE_API_URL}/delete_politica/${id}`, {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',
          },
