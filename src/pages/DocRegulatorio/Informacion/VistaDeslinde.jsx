...
const VistaDeslinde = ({ showModal, onClose }) => {
  ...
  useEffect(() => {
    const fetchDeslindes = async () => {
      try {
        const response = await fetch('https://localhost:4000/api/getCurrentDeslindes');
  ...
  return (
    <Modal
      ...
      style={{
        overlay: {
          backgroundColor: 'rgba(0, 0, 0, 0.7)', // Color de fondo del overlay
        },
        content: {
          top: '50%',
          left: '50%',
...
VistaDeslinde.propTypes = {
  showModal: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
};

export default VistaDeslinde;
