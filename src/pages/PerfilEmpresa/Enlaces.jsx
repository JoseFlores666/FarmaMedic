...
const Enlaces = () => {
  ...
  const handleDelete = async (id) => {
    ...
    if (confirm.isConfirmed) {
      try {
        const response = await fetch(`${import.meta.env.VITE_API_URL}/deleteEnlace/${id}`, {
          method: 'DELETE',
          credentials: 'include',
  ...
  const handleSubmit = async (e) => {
    ...
    const url = editMode ? `${import.meta.env.VITE_API_URL}/updateEnlace/${newLink.id}` : `${import.meta.env.VITE_API_URL}/createEnlace`;
