...
import { FaFacebook, FaTwitter, FaLinkedin, FaInstagram, FaRedo } from 'react-icons/fa'; 
    ...
    <div>
      <footer className="text-center text-lg-start text-white" style={{ backgroundColor: '#1c2331' }}>
        <section className="d-flex justify-content-between p-4">
          ...
          {isAdmin && (
            <div className="refresh-icon text-end" style={{ cursor: 'pointer', display: 'inline-block' }} onClick={recarga}>
